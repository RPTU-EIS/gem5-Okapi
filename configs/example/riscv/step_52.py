...
assert os.path.exists(args.checkpoint_path), f"Checkpoint not found at {args.checkpoint_path}"


checkpoint_name = os.path.basename(args.checkpoint_path)
output_stats_dir = f"/import/lab/users/joseph/Documents/RISCV2/gem5-Okapi/neha/stats_output/400.perlbench/{checkpoint_name}"
