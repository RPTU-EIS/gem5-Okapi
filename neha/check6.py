...
parser.add_argument("--benchmark", required=True, help="Name of the benchmark folder")
...
temp_init_script = f"""
#!/bin/bash
echo "{gem5_init_script}" > /root/gem5_init.sh
...
#memory_ranges = [AddrRange(start=0x80000000, size='8GB')]
#system.mem_ranges = memory_ranges
...
system.set_kernel_disk_workload(
    ...
    readfile_contents=temp_init_script
)


system.workload.command_line = "console=ttyS0 root=/dev/vda1 rw init=/root/gem5_init.sh"
